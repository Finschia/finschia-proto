...
export class QueryClientImpl implements Query {
  ...
  ContractHistory(
    ...
    return promise.then((data) =>
      QueryContractHistoryResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  AllContractState(
    ...
    return promise.then((data) =>
      QueryAllContractStateResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  RawContractState(
    ...
    return promise.then((data) =>
      QueryRawContractStateResponse.decode(new _m0.Reader(data))
    );
  }
