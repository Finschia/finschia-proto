...
export interface GetBlockResultsByHeightRequest {
  height: Long;
}

/** GetBlockResultsByHeightResponse is the response type for the Query/GetBlockResultsByHeight RPC method. */
export interface GetBlockResultsByHeightResponse {
  height: Long;
  txsResults: ResponseDeliverTx[];
  resBeginBlock?: ResponseBeginBlock;
  resEndBlock?: ResponseEndBlock;
}
...
function createBaseGetBlockByHashRequest(): GetBlockByHashRequest {
...
export const GetBlockByHashRequest = {
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetBlockByHashRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GetBlockByHashRequest {
    return {
  ...
  toJSON(message: GetBlockByHashRequest): unknown {
    const obj: any = {};
  ...
  fromPartial<I extends Exact<DeepPartial<GetBlockByHashRequest>, I>>(
    object: I
  ): GetBlockByHashRequest {
    const message = createBaseGetBlockByHashRequest();
...
function createBaseGetBlockByHashResponse(): GetBlockByHashResponse {
  return { blockId: undefined, block: undefined };
}

export const GetBlockByHashResponse = {
  encode(
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetBlockByHashResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  fromJSON(object: any): GetBlockByHashResponse {
    return {
      blockId: isSet(object.blockId)
        ? BlockID.fromJSON(object.blockId)
        : undefined,
  ...
  toJSON(message: GetBlockByHashResponse): unknown {
    const obj: any = {};
    message.blockId !== undefined &&
      (obj.blockId = message.blockId
        ? BlockID.toJSON(message.blockId)
  ...
  fromPartial<I extends Exact<DeepPartial<GetBlockByHashResponse>, I>>(
    object: I
  ): GetBlockByHashResponse {
    const message = createBaseGetBlockByHashResponse();
    message.blockId =
...
function createBaseGetBlockResultsByHeightRequest(): GetBlockResultsByHeightRequest {
  return { height: Long.ZERO };
}

export const GetBlockResultsByHeightRequest = {
  encode(
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetBlockResultsByHeightRequest();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
  ...
  toJSON(message: GetBlockResultsByHeightRequest): unknown {
    const obj: any = {};
    message.height !== undefined &&
      (obj.height = (message.height || Long.ZERO).toString());
    return obj;
  ...
  fromPartial<I extends Exact<DeepPartial<GetBlockResultsByHeightRequest>, I>>(
    object: I
  ): GetBlockResultsByHeightRequest {
    const message = createBaseGetBlockResultsByHeightRequest();
    message.height =
...
function createBaseGetBlockResultsByHeightResponse(): GetBlockResultsByHeightResponse {
  return {
    height: Long.ZERO,
    txsResults: [],
    resBeginBlock: undefined,
    resEndBlock: undefined,
  };
}

export const GetBlockResultsByHeightResponse = {
  encode(
    ...
    if (message.resBeginBlock !== undefined) {
      ResponseBeginBlock.encode(
        message.resBeginBlock,
        writer.uint32(26).fork()
      ).ldelim();
    }
    if (message.resEndBlock !== undefined) {
  ...
  decode(
    ...
    const reader = input instanceof _m0.Reader ? input : new _m0.Reader(input);
    let end = length === undefined ? reader.len : reader.pos + length;
    const message = createBaseGetBlockResultsByHeightResponse();
    while (reader.pos < end) {
      const tag = reader.uint32();
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.txsResults.push(
            ResponseDeliverTx.decode(reader, reader.uint32())
          );
          break;
        case 3:
          message.resBeginBlock = ResponseBeginBlock.decode(
            reader,
            reader.uint32()
          );
          break;
        case 4:
          message.resEndBlock = ResponseEndBlock.decode(
            reader,
            reader.uint32()
          );
          break;
  ...
  fromJSON(object: any): GetBlockResultsByHeightResponse {
    return {
      ...
      txsResults: Array.isArray(object?.txsResults)
        ...
        : [],
      resBeginBlock: isSet(object.resBeginBlock)
        ? ResponseBeginBlock.fromJSON(object.resBeginBlock)
        : undefined,
      resEndBlock: isSet(object.resEndBlock)
        ? ResponseEndBlock.fromJSON(object.resEndBlock)
        : undefined,
    };
  },

  toJSON(message: GetBlockResultsByHeightResponse): unknown {
    const obj: any = {};
    message.height !== undefined &&
      (obj.height = (message.height || Long.ZERO).toString());
    if (message.txsResults) {
      obj.txsResults = message.txsResults.map((e) =>
        e ? ResponseDeliverTx.toJSON(e) : undefined
      );
    } else {
      obj.txsResults = [];
    }
    message.resBeginBlock !== undefined &&
      (obj.resBeginBlock = message.resBeginBlock
        ? ResponseBeginBlock.toJSON(message.resBeginBlock)
        : undefined);
    message.resEndBlock !== undefined &&
      (obj.resEndBlock = message.resEndBlock
        ? ResponseEndBlock.toJSON(message.resEndBlock)
        : undefined);
    return obj;
  },

  fromPartial<I extends Exact<DeepPartial<GetBlockResultsByHeightResponse>, I>>(
    object: I
  ): GetBlockResultsByHeightResponse {
    const message = createBaseGetBlockResultsByHeightResponse();
    message.height =
      object.height !== undefined && object.height !== null
        ...
        : Long.ZERO;
    message.txsResults =
      object.txsResults?.map((e) => ResponseDeliverTx.fromPartial(e)) || [];
    message.resBeginBlock =
      object.resBeginBlock !== undefined && object.resBeginBlock !== null
        ? ResponseBeginBlock.fromPartial(object.resBeginBlock)
        : undefined;
    message.resEndBlock =
      object.resEndBlock !== undefined && object.resEndBlock !== null
        ? ResponseEndBlock.fromPartial(object.resEndBlock)
        : undefined;
    return message;
  },
};
...
export interface Service {
  ...
  GetBlockResultsByHeight(
    request: GetBlockResultsByHeightRequest
  ): Promise<GetBlockResultsByHeightResponse>;
...
export class ServiceClientImpl implements Service {
  ...
  constructor(rpc: Rpc) {
    ...
    this.GetBlockResultsByHeight = this.GetBlockResultsByHeight.bind(this);
  ...
  GetBlockByHash(
    ...
    const data = GetBlockByHashRequest.encode(request).finish();
    const promise = this.rpc.request(
      "lbm.base.ostracon.v1.Service",
      "GetBlockByHash",
      data
    ...
    return promise.then((data) =>
      GetBlockByHashResponse.decode(new _m0.Reader(data))
    );
  }
  ...
  GetBlockResultsByHeight(
    ...
    const data = GetBlockResultsByHeightRequest.encode(request).finish();
    const promise = this.rpc.request(
      "lbm.base.ostracon.v1.Service",
      "GetBlockResultsByHeight",
      data
    ...
    return promise.then((data) =>
      GetBlockResultsByHeightResponse.decode(new _m0.Reader(data))
    );
  }
