...
import { Params, Metadata } from "../../../lbm/bank/v1/bank";

export const protobufPackage = "lbm.bank.v1";
...
export class QueryClientImpl implements Query {
  ...
  Balance(request: QueryBalanceRequest): Promise<QueryBalanceResponse> {
    ...
    const promise = this.rpc.request("lbm.bank.v1.Query", "Balance", data);
  ...
  AllBalances(
    ...
    const promise = this.rpc.request("lbm.bank.v1.Query", "AllBalances", data);
    return promise.then((data) =>
  ...
  TotalSupply(
    ...
    const promise = this.rpc.request("lbm.bank.v1.Query", "TotalSupply", data);
    return promise.then((data) =>
  ...
  SupplyOf(request: QuerySupplyOfRequest): Promise<QuerySupplyOfResponse> {
    ...
    const promise = this.rpc.request("lbm.bank.v1.Query", "SupplyOf", data);
    return promise.then((data) =>
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("lbm.bank.v1.Query", "Params", data);
    return promise.then((data) =>
