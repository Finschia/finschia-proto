...
export const protobufPackage = "lbm.gov.v1";
...
export class QueryClientImpl implements Query {
  ...
  Proposal(request: QueryProposalRequest): Promise<QueryProposalResponse> {
    ...
    const promise = this.rpc.request("lbm.gov.v1.Query", "Proposal", data);
  ...
  Proposals(request: QueryProposalsRequest): Promise<QueryProposalsResponse> {
    ...
    const promise = this.rpc.request("lbm.gov.v1.Query", "Proposals", data);
    return promise.then((data) =>
  ...
  Vote(request: QueryVoteRequest): Promise<QueryVoteResponse> {
    ...
    const promise = this.rpc.request("lbm.gov.v1.Query", "Vote", data);
    return promise.then((data) =>
  ...
  Votes(request: QueryVotesRequest): Promise<QueryVotesResponse> {
    ...
    const promise = this.rpc.request("lbm.gov.v1.Query", "Votes", data);
    return promise.then((data) =>
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("lbm.gov.v1.Query", "Params", data);
    return promise.then((data) =>
  ...
  Deposit(request: QueryDepositRequest): Promise<QueryDepositResponse> {
    ...
    const promise = this.rpc.request("lbm.gov.v1.Query", "Deposit", data);
    return promise.then((data) =>
  ...
  Deposits(request: QueryDepositsRequest): Promise<QueryDepositsResponse> {
    ...
    const promise = this.rpc.request("lbm.gov.v1.Query", "Deposits", data);
    return promise.then((data) =>
  ...
  TallyResult(
    ...
    const promise = this.rpc.request("lbm.gov.v1.Query", "TallyResult", data);
    return promise.then((data) =>
