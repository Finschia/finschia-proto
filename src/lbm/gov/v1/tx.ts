...
export class MsgClientImpl implements Msg {
  ...
  SubmitProposal(
    ...
    const promise = this.rpc.request("lbm.gov.v1.Msg", "SubmitProposal", data);
  ...
  Vote(request: MsgVote): Promise<MsgVoteResponse> {
    ...
    const promise = this.rpc.request("lbm.gov.v1.Msg", "Vote", data);
    return promise.then((data) => MsgVoteResponse.decode(new _m0.Reader(data)));
  }

  VoteWeighted(request: MsgVoteWeighted): Promise<MsgVoteWeightedResponse> {
    const data = MsgVoteWeighted.encode(request).finish();
    const promise = this.rpc.request("lbm.gov.v1.Msg", "VoteWeighted", data);
    return promise.then((data) =>
  ...
  Deposit(request: MsgDeposit): Promise<MsgDepositResponse> {
    ...
    const promise = this.rpc.request("lbm.gov.v1.Msg", "Deposit", data);
    return promise.then((data) =>
