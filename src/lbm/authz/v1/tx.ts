...
import { Grant } from "../../../lbm/authz/v1/authz";
import { Any } from "../../../google/protobuf/any";

export const protobufPackage = "lbm.authz.v1";
...
export class MsgClientImpl implements Msg {
  ...
  Grant(request: MsgGrant): Promise<MsgGrantResponse> {
    ...
    const promise = this.rpc.request("lbm.authz.v1.Msg", "Grant", data);
  ...
  Exec(request: MsgExec): Promise<MsgExecResponse> {
    ...
    const promise = this.rpc.request("lbm.authz.v1.Msg", "Exec", data);
    return promise.then((data) => MsgExecResponse.decode(new _m0.Reader(data)));
  }

  Revoke(request: MsgRevoke): Promise<MsgRevokeResponse> {
    const data = MsgRevoke.encode(request).finish();
    const promise = this.rpc.request("lbm.authz.v1.Msg", "Revoke", data);
    return promise.then((data) =>
