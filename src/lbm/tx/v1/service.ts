...
import { TxResponse, GasInfo, Result } from "../../../lbm/base/abci/v1/abci";
import { Tx } from "../../../lbm/tx/v1/tx";
...
export class ServiceClientImpl implements Service {
  ...
  Simulate(request: SimulateRequest): Promise<SimulateResponse> {
    ...
    const promise = this.rpc.request("lbm.tx.v1.Service", "Simulate", data);
  ...
  GetTx(request: GetTxRequest): Promise<GetTxResponse> {
    ...
    const promise = this.rpc.request("lbm.tx.v1.Service", "GetTx", data);
    return promise.then((data) => GetTxResponse.decode(new _m0.Reader(data)));
  }

  BroadcastTx(request: BroadcastTxRequest): Promise<BroadcastTxResponse> {
    const data = BroadcastTxRequest.encode(request).finish();
    const promise = this.rpc.request("lbm.tx.v1.Service", "BroadcastTx", data);
    return promise.then((data) =>
  ...
  GetTxsEvent(request: GetTxsEventRequest): Promise<GetTxsEventResponse> {
    ...
    const promise = this.rpc.request("lbm.tx.v1.Service", "GetTxsEvent", data);
    return promise.then((data) =>
