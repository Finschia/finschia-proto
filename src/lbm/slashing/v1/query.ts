...
} from "../../../lbm/slashing/v1/slashing";
import {
  PageRequest,
  PageResponse,
} from "../../../lbm/base/query/v1/pagination";

export const protobufPackage = "lbm.slashing.v1";
...
export class QueryClientImpl implements Query {
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("lbm.slashing.v1.Query", "Params", data);
