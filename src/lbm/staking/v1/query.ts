...
} from "../../../lbm/staking/v1/staking";

export const protobufPackage = "lbm.staking.v1";
...
export class QueryClientImpl implements Query {
  ...
  Validator(request: QueryValidatorRequest): Promise<QueryValidatorResponse> {
    ...
    const promise = this.rpc.request("lbm.staking.v1.Query", "Validator", data);
    return promise.then((data) =>
  ...
  Pool(request: QueryPoolRequest): Promise<QueryPoolResponse> {
    ...
    const promise = this.rpc.request("lbm.staking.v1.Query", "Pool", data);
    return promise.then((data) =>
  ...
  Params(request: QueryParamsRequest): Promise<QueryParamsResponse> {
    ...
    const promise = this.rpc.request("lbm.staking.v1.Query", "Params", data);
    return promise.then((data) =>
