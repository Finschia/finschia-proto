...
import { Description, CommissionRates } from "../../../lbm/staking/v1/staking";
...
export class MsgClientImpl implements Msg {
  ...
  Delegate(request: MsgDelegate): Promise<MsgDelegateResponse> {
    ...
    const promise = this.rpc.request("lbm.staking.v1.Msg", "Delegate", data);
    return promise.then((data) =>
  ...
  Undelegate(request: MsgUndelegate): Promise<MsgUndelegateResponse> {
    ...
    const promise = this.rpc.request("lbm.staking.v1.Msg", "Undelegate", data);
    return promise.then((data) =>
